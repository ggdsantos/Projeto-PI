...
public class Main {
	...
	public static void desf1() {
		if (vitorias >= 3 && !desafiosAtivados[0]) {
			System.out.println("Bem-vindo ao Quiz Game!");
	...
	public static void quizEgito(Scanner scanner) {
		...
		if (resposta == 2) {
			...
			saldo -= saldo / 2;
			System.out.println("Você perdeu no desafio.");
		}
	}

	public static void quizCartas(Scanner scanner) {
		System.out.println("Tema: Cartas");
	...
	public static void quizNumeros(Scanner scanner) {
		System.out.println("Tema: Números");
	...
	public static void desf4() {
		...
		for (int tentativa = 1; tentativa <= tentativasMaximas; tentativa++) {
			...
			if (palpite.length() != 6) {
				System.out.println("Por favor, insira uma palavra de 6 letras.");
				tentativa--;
				continue;
			}
			...
			if (palpite.equals(palavraSecreta)) {
				...
				System.out.println("Posições corretas: " + posicoesCorretas);
	...
	public static void Mult() {
		...
		// em andamento
		{
			...
			while (true) {
				System.out.println("Jogador 1, digite quanto será seu saldo (De 5 a 5000 reais): ");
			...
			while (true) {
				System.out.println("Jogador 2, digite quanto será seu saldo (De 5 a 5000 reais): ");
			...
			while (!sairDoJogo) {
				...
				while (true) {
					System.out.print("\nJogador 1, escolha seu primeiro número (entre 1 e 13): ");
					escolhaJogador1Numero1 = ler.nextInt();
					if (escolhaJogador1Numero1 < 1 || escolhaJogador1Numero1 > 13) {
						System.out.println("Número inválido! Escolha um número entre 1 e 13.");
						continue;
					}

					System.out.print("Jogador 1, escolha seu segundo número (entre 1 e 13): ");
					...
					if (escolhaJogador1Numero1 != escolhaJogador1Numero2) {
						...
						System.out.println("Os números escolhidos devem ser diferentes. Tente novamente.");
					}
				}

				while (true) {
					System.out.print("\nJogador 2, escolha seu primeiro número (entre 1 e 13): ");
					...
					System.out.print("Jogador 2, escolha seu segundo número (entre 1 e 13): ");
				...
				boolean jogador1Ganha1 = sorteados.contains(escolhaJogador1Numero1);
				boolean jogador1Ganha2 = sorteados.contains(escolhaJogador1Numero2);
				boolean jogador2Ganha1 = sorteados.contains(escolhaJogador2Numero1);
				boolean jogador2Ganha2 = sorteados.contains(escolhaJogador2Numero2);

				if (jogador1Ganha1 && jogador1Ganha2) {
					System.out.println("\nJogador 1 acertou os dois números!");
					saldoJogador1 += apostaJogador2;
					saldoJogador2 -= apostaJogador2;
				} else if (jogador2Ganha1 && jogador2Ganha2) {
					System.out.println("\nJogador 2 acertou os dois números!");
					saldoJogador1 -= apostaJogador1;
					saldoJogador2 += apostaJogador1;
				} else if (jogador1Ganha1 || jogador1Ganha2) {
					System.out.println("\nJogador 1 acertou um dos números!");
					saldoJogador1 += apostaJogador2;
					saldoJogador2 -= apostaJogador2;
				} else if (jogador2Ganha1 || jogador2Ganha2) {
					System.out.println("\nJogador 2 acertou um dos números!");
					saldoJogador1 -= apostaJogador1;
					saldoJogador2 += apostaJogador1;
				} else {
					System.out.println("\nNenhum jogador acertou nenhum número. Ambos perdem suas apostas.");
					saldoJogador1 -= apostaJogador1;
					saldoJogador2 -= apostaJogador2;
				}
	...
	public static void guiaJogo(int numero) {
		...
		System.out.println("-----------------------------------------------");
		System.out.println("Você ganha se sair três cartas iguais, se sair um 3, "
				+ "se sair três cartas com 7, se sair um " + numero + " ou se sair três cartas com " + numero);
